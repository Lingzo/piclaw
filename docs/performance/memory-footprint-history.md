...
|---|---|---:|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 2026-04-18T07:31:17Z | `ca768600` | yes | Live `piclaw.service` after the most recent 07:27Z restart, measured under light interactive load on the current main branch | 223.8 MB | 222.8 MB | 193.4 MB | 237.1 MB | 70.8 MB | 38.4 MB | 1 | 1 | 0 | Service PID 94278 on `:8080`. Runtime counters at capture time: `create_in_flight=0`, `prewarm_in_flight=0`, `queued_prewarms=0`. The restart emitted `.piclaw/data/startup-memory-snapshots/2026-04-18T07-27-49-968Z_post-web-start.json`, a fresh post-start sample at 212.7 MB RSS / 38.8 MB heap / 15.9 MB external with `cached_main_sessions=0` and `active_chats=0`. The workspace was dirty only because of unrelated local note/measurement artifacts that were intentionally left untouched; by 07:31Z the live process was still close to the new restart baseline, making this the replacement RAM-work checkpoint row. |
