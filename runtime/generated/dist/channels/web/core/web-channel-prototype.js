...
export function installWebChannelPrototype(target, defaults) {
    Object.defineProperties(target, {
        ...
        handleTerminalHandoff: {
            configurable: true,
            writable: true,
            value: withHttpSurface((service, req) => service.handleTerminalHandoff(req)),
        },
        handleVncSession: {
            configurable: true,
            writable: true,
        ...
        handleSessionTree: {
            configurable: true,
            writable: true,
            value: withHttpSurface((service, req) => service.handleSessionTree(req)),
        },
        handleSystemMetrics: {
            configurable: true,
            writable: true,
            value: withHttpSurface((service, req) => service.handleSystemMetrics(req)),
        },
